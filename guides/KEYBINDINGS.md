...
| `Num *`                | Включить/выключить микрофон; звуковой сигнал подтверждает состояние |
...
Запуск: `y`. После выхода терминал перейдёт в последний открытый каталог.

| Клавиша                 | Действие                                    |
| ----------------------- | ------------------------------------------- |
| `j` / `k` или `↓` / `↑` | Перейти к следующему / предыдущему файлу    |
| `h` / `l` или `←` / `→` | Перейти в родительский / выбранный каталог  |
| `Enter`                 | Открыть файл или каталог                    |
| `Space`                 | Выделить файл                               |
| `v`                     | Включить режим выделения нескольких файлов  |
| `y`                     | Скопировать выделенные файлы                |
| `x`                     | Вырезать выделенные файлы                   |
| `p`                     | Вставить скопированные или вырезанные файлы |
| `d`                     | Переместить выделенные файлы в корзину      |
| `/`                     | Найти файл по имени                         |
| `q`                     | Выйти из Yazi                               |
